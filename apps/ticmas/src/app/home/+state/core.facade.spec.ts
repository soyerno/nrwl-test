...
describe('CoreFacade', () => {
  ...
  describe('used in NgModule', () => {
    beforeEach(() => {
      @NgModule({
        imports: [
          StoreModule.forFeature('core', reducer, { initialState }),
    ...
    /**
     * Use `CoreLoaded` to manually submit list for state management
     */
    it('allCore$ should return the loaded list; and loaded flag == true', async done => {
      try {
        ...
        store.dispatch(new CoreLoaded([createCore('AAA'), createCore('BBB')]));
